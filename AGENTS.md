...
The canonical, vendor-neutral instructions for this role are mirrored verbatim
below (source: `python/python/observa/_agent/AGENTS.template.md`, also shipped
inside the wheel at `observa.agent_agents_template_path()`). Do not edit the
three copies independently — edit the template and re-mirror.

<!-- BEGIN GENERATED: agent-strategy-authoring -->
...
behaviour.
<!-- END GENERATED: agent-strategy-authoring -->
