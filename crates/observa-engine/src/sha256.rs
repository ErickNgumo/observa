...
//!
//! Used for deterministic content hashing of datasets and strategy sources so
//! that run reproducibility metadata does not depend on external crates.
...
impl Sha256 {
    ...
    /// Convenience: hash a byte slice and return a lowercase hex string.
