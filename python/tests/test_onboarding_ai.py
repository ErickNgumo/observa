...
Covers:
1. Version diagnostic regression: observa.__version__ == "0.1.5" and
...
def test_version_diagnostic():
    _check("version == 0.1.5", observa.__version__ == "0.1.5", observa.__version__)
...
def test_llms_full_markers():
    ...
    required = [
        ...
        "releases/download/observa-0.1.5-private-mvp",
        "explicit ticket",
        "dataset_source",
        "sl-first",
        "lookahead",
