# Tester Onboarding — Observa 0.1.5 (Private MVP)
...
SHA-256: `1c912e05c889ea688ce9a985ce2720d918293495215e14013f66f2125ea43f38`
...
```python
import observa
print(observa.__version__)   # should print 0.1.5
